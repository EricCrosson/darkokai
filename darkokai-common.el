;;; darkokai-common.el --- A darker variant on Monokai.
...
(defmacro darkokai-with-color-vars (variant &rest body)
  (declare (indent 0))
  `(let* ((class '((class color) (min-colors 257)))
          ;; Primary colors
          (darkokai-yellow           (if (eq ,variant 'dark) "#E6DB74" "#19248B"))
          (darkokai-orange           (if (eq ,variant 'dark) "#ffac4a" "#0053B5"))
          (darkokai-red              (if (eq ,variant 'dark) "#ff0066" "#00FF99"))
          (darkokai-magenta          (if (eq ,variant 'dark) "#ff8eff" "#007100"))
          (darkokai-violet           (if (eq ,variant 'dark) "#ab7eff" "#548100"))
          (darkokai-blue             (if (eq ,variant 'dark) "#06d8ff" "#F92700"))
          (darkokai-cyan             (if (eq ,variant 'dark) "#53f2dc" "#AC0D23"))
          (darkokai-green            (if (eq ,variant 'dark) "#63de5d" "#9C21A2"))
          (darkokai-gray             (if (eq ,variant 'dark) "#35393b" "#CAC6C4"))
          ;; Darker and lighter accented colors
          (darkokai-yellow-d         (if (eq ,variant 'dark) "#BEB244" "#414DBB"))
          (darkokai-yellow-l         (if (eq ,variant 'dark) "#FFF7A8" "#000857"))
          (darkokai-orange-d         (if (eq ,variant 'dark) "#de8f2d" "#2170D2"))
          (darkokai-orange-l         (if (eq ,variant 'dark) "#ffc260" "#003D9F"))
          (darkokai-red-d            (if (eq ,variant 'dark) "#F70057" "#08FFA8"))
          (darkokai-red-l            (if (eq ,variant 'dark) "#FE61A0" "#019E5F"))
          (darkokai-magenta-d        (if (eq ,variant 'dark) "#FF61FF" "#009E00"))
          (darkokai-magenta-l        (if (eq ,variant 'dark) "#FFC4FF" "#003B00"))
          (darkokai-violet-d         (if (eq ,variant 'dark) "#9257FF" "#6DA800"))
          (darkokai-violet-l         (if (eq ,variant 'dark) "#C9ACFF" "#365300"))
          (darkokai-blue-d           (if (eq ,variant 'dark) "#40CAE4" "#BF351B"))
          (darkokai-blue-l           (if (eq ,variant 'dark) "#92E7F7" "#6D1808"))
          (darkokai-cyan-d           (if (eq ,variant 'dark) "#00b2ac" "#FF4D53"))
          (darkokai-cyan-l           (if (eq ,variant 'dark) "#BBF7EF" "#440810"))
          (darkokai-green-d          (if (eq ,variant 'dark) "#86C30D" "#793CF2"))
          (darkokai-green-l          (if (eq ,variant 'dark) "#BBEF53" "#4410AC"))
          (darkokai-gray-ld          (if (eq ,variant 'dark) "#383c3d" "#C7C3C2"))
          (darkokai-gray-d           (if (eq ,variant 'dark) "#35393b" "#CAC6C4"))
          (darkokai-gray-dd          (if (eq ,variant 'dark) "#2B2F31" "#D4D0CE"))
          (darkokai-gray-l           (if (eq ,variant 'dark) "#515759" "#AEA8A6"))
          (darkokai-green-plain      (if (eq ,variant 'dark) "#2AD043" "#D52FBC"))
          (darkokai-red-plain        (if (eq ,variant 'dark) "#FF6159" "#009EA6"))
          ;; Adaptive colors
          (darkokai-fg               (if (eq ,variant 'dark) "#f8fbfc" "#070403"))
          (darkokai-bg               (if (eq ,variant 'dark) "#242728" "#DBD8D7"))
          (darkokai-highlight-line   (if (eq ,variant 'dark) "#424748" "#BDB8B7"))
          (darkokai-highlight        (if (eq ,variant 'dark) "#5D6365" "#A29C9A"))
          (darkokai-emph             (if (eq ,variant 'dark) "#ffffff" "#000000"))
          (darkokai-comments         (if (eq ,variant 'dark) "#6A6D70" "#95928F"))
          ;; Adaptive higher/lower contrast accented colors
          (darkokai-fg-hc            (if (eq ,variant 'dark) "#141414" "#EBEBEB"))
          (darkokai-fg-lc            (if (eq ,variant 'dark) "#171A0B" "#E8E5F4"))
          ;; High contrast colors
          (darkokai-yellow-hc        (if (eq ,variant 'dark) "#FFFACE" "#000531"))
          (darkokai-yellow-lc        (if (eq ,variant 'dark) "#9A8F21" "#6570DE"))
          (darkokai-orange-hc        (if (eq ,variant 'dark) "#FFBE74" "#00418B"))
          (darkokai-orange-lc        (if (eq ,variant 'dark) "#A75B00" "#58A4FF"))
          (darkokai-red-hc           (if (eq ,variant 'dark) "#FEB0CC" "#014F33"))
          (darkokai-red-lc           (if (eq ,variant 'dark) "#F20055" "#0DFFAA"))
          (darkokai-magenta-hc       (if (eq ,variant 'dark) "#FEC6F9" "#013906"))
          (darkokai-magenta-lc       (if (eq ,variant 'dark) "#F309DF" "#0CF620"))
          (darkokai-violet-hc        (if (eq ,variant 'dark) "#F0E7FF" "#0F1800"))
          (darkokai-violet-lc        (if (eq ,variant 'dark) "#7830FC" "#87CF03"))
          (darkokai-blue-hc          (if (eq ,variant 'dark) "#CAF5FD" "#350A02"))
          (darkokai-blue-lc          (if (eq ,variant 'dark) "#1DB4D0" "#E24B2F"))
          (darkokai-cyan-hc          (if (eq ,variant 'dark) "#D3FBF6" "#2C0409"))
          (darkokai-cyan-lc          (if (eq ,variant 'dark) "#4BBEAE" "#B44151"))
          (darkokai-green-hc         (if (eq ,variant 'dark) "#CCF47C" "#330B83"))
          (darkokai-green-lc         (if (eq ,variant 'dark) "#63de5d" "#9C21A2"))
          ...
          ;; Primary colors
          (terminal-darkokai-yellow           (if (eq ,variant 'dark) "#CDC673" "#32398C"))
          (terminal-darkokai-orange           (if (eq ,variant 'dark) "#FF8C00" "#0073FF"))
          (terminal-darkokai-red              (if (eq ,variant 'dark) "#FF1493" "#00EB6C"))
          (terminal-darkokai-magenta          (if (eq ,variant 'dark) "#D700D7" "#28FF28"))
          (terminal-darkokai-violet           (if (eq ,variant 'dark) "#AF87FF" "#507800"))
          (terminal-darkokai-blue             (if (eq ,variant 'dark) "#5FD7FF" "#A02800"))
          (terminal-darkokai-cyan             (if (eq ,variant 'dark) "#5FFFFF" "#A00000"))
          (terminal-darkokai-green            (if (eq ,variant 'dark) "#87D700" "#7828FF"))
          (terminal-darkokai-gray             (if (eq ,variant 'dark) "#3D3D3D" "#C2C2C2"))
          ;; Darker and lighter accented colors
          (terminal-darkokai-yellow-d         (if (eq ,variant 'dark) "#878700" "#7878FF"))
          (terminal-darkokai-yellow-l         (if (eq ,variant 'dark) "#FFFF87" "#000078"))
          (terminal-darkokai-orange-d         (if (eq ,variant 'dark) "#AF5F00" "#50A0FF"))
          (terminal-darkokai-orange-l         (if (eq ,variant 'dark) "#FFAF5F" "#0050A0"))
          (terminal-darkokai-red-d            (if (eq ,variant 'dark) "#870000" "#78FFFF"))
          (terminal-darkokai-red-l            (if (eq ,variant 'dark) "#FF5F87" "#00A078"))
          (terminal-darkokai-magenta-d        (if (eq ,variant 'dark) "#AF0087" "#50FF78"))
          (terminal-darkokai-magenta-l        (if (eq ,variant 'dark) "#FF87DF" "#007820"))
          (terminal-darkokai-violet-d         (if (eq ,variant 'dark) "#5F00AF" "#A0FF50"))
          (terminal-darkokai-violet-l         (if (eq ,variant 'dark) "#AF87D7" "#507828"))
          (terminal-darkokai-blue-d           (if (eq ,variant 'dark) "#008787" "#FF7878"))
          (terminal-darkokai-blue-l           (if (eq ,variant 'dark) "#87D7FF" "#782800"))
          (terminal-darkokai-cyan-d           (if (eq ,variant 'dark) "#5FAFAF" "#A05050"))
          (terminal-darkokai-cyan-l           (if (eq ,variant 'dark) "#AFFFFF" "#500000"))
          (terminal-darkokai-green-d          (if (eq ,variant 'dark) "#5F8700" "#A078FF"))
          (terminal-darkokai-green-l          (if (eq ,variant 'dark) "#AFD700" "#5028FF"))
          (terminal-darkokai-gray-d           (if (eq ,variant 'dark) "#333333" "#CCCCCC"))
          (terminal-darkokai-gray-l           (if (eq ,variant 'dark) "#707070" "#8F8F8F"))
          ;; Adaptive colors
          (terminal-darkokai-fg               (if (eq ,variant 'dark) "#F5F5F5" "#0A0A0A"))
          (terminal-darkokai-bg               (if (eq ,variant 'dark) "#1B1E1C" "#E4E1E3"))
          (terminal-darkokai-highlight-line   (if (eq ,variant 'dark) "#474747" "#B8B8B8"))
          (terminal-darkokai-highlight        (if (eq ,variant 'dark) "#F4A460" "#0B5B9F"))
          (terminal-darkokai-emph             (if (eq ,variant 'dark) "#FFFAFA" "#000505"))
          (terminal-darkokai-comments         (if (eq ,variant 'dark) "#8B8878" "#747787"))
          ;; Adaptive higher/lower contrast accented colors
          (terminal-darkokai-fg-hc            (if (eq ,variant 'dark) "#171A0B" "#E8E5F4"))
          (terminal-darkokai-fg-lc            (if (eq ,variant 'dark) "#141414" "#EBEBEB"))
          ;; High contrast colors
...
(defun create-darkokai-theme (variant theme)
  "Create a darkokai theme."
  (darkokai-with-color-vars
    ...
    ;;           (terminal-darkokai-fg-lc            (if (eq ,variant 'dark) "#141414" "#EBEBEB"))
     ...
     `(vc-annotate-color-map
       '((20 . ,darkokai-red)
         (40 . (if (eq ,variant 'dark) "#CF4F1F" "#30B0E0"))
         (60 . (if (eq ,variant 'dark) "#C26C0F" "#3D93F0"))
         (80 . ,darkokai-yellow)
         (100 . (if (eq ,variant 'dark) "#AB8C00" "#5473FF"))
         (120 . (if (eq ,variant 'dark) "#A18F00" "#5E70FF"))
         (140 . (if (eq ,variant 'dark) "#989200" "#676DFF"))
         (160 . (if (eq ,variant 'dark) "#8E9500" "#716AFF"))
         (180 . ,darkokai-green)
         (200 . (if (eq ,variant 'dark) "#729A1E" "#8D65E1"))
         (220 . (if (eq ,variant 'dark) "#609C3C" "#9F63C3"))
         (240 . (if (eq ,variant 'dark) "#4E9D5B" "#B162A4"))
         (260 . (if (eq ,variant 'dark) "#3C9F79" "#C36086"))
         (280 . ,darkokai-cyan)
         (300 . (if (eq ,variant 'dark) "#299BA6" "#D66459"))
         (320 . (if (eq ,variant 'dark) "#2896B5" "#D7694A"))
         (340 . (if (eq ,variant 'dark) "#2790C3" "#D86F3C"))
         (360 . ,darkokai-blue)))
